...
@section('content')
    ...
    <div class="card">
    	<div class="card-body">
    		<a href="{{ route('document.create') }}" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Nuevo Documento</a>
    	</div>
    </div>
	  	...
	  	<div class="col mb-4">
		    <div class="card">
		      ...
		      <div class="card-footer">
				...
				<a href="{{ route('document.edit', $key->id) }}" class="btn btn-warning"><i class="fas fa-edit mr-2"></i>Editar</a>
					<form method="POST" action="{{ url("admin/document/{$key->id}") }}">
						@csrf
  						@method('DELETE')
    ...
    <script>
    	...
    	$(document).ready(function() {
		    ...
		    $(".custom-switch .check").on( 'change', function() {		    	
			    ...
			    $.ajax({
	                url: "{{ route('document.updateStatus') }}",
	                method: 'POST',
	                data:{
